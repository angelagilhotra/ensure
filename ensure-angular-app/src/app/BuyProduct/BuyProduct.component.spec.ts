...
describe('BuyProductComponent', () => {
  ...
  let mockBuyProductService;
  let mockDataService

  beforeEach(async(() => {

    mockBuyProductService = sinon.createStubInstance(BuyProductService);
    mockBuyProductService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: BuyProductService, useValue: mockBuyProductService },
